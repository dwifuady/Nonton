...
public class SeriesCatalog : Catalog
{
    ...
    public override string CatalogTitle => AddonConstants.AddonTypeSeriesTitle;
    public override string CatalogShortName => AddonConstants.AddonTypeSeriesShortName;
